...
static char const *sipc_layer_string[] = {
	[LINK] = "LNK",
	[IODEV] = "IOD",
	[APP] = "APP",
...
static char const *dev_format_string[] = {
	[IPC_FMT]	= "FMT",
	[IPC_RAW]	= "RAW",
	[IPC_RFS]	= "RFS",
...
static char const *q_direction_string[] = {
	[TX] = "TXQ",
	[RX] = "RXQ"
};
...
static char const *ipc_direction_string[] = {
	[TX] = "AP->CP",
	[RX] = "AP<-CP"
};
...
static char const *arrow_direction[] = {
	[TX] = "->",
	[RX] = "<-"
};
...
static char const *modem_state_string[] = {
